...
const BannerBottom = () => {
  return (
    ...
    //     <div className="flex justify-center items-center gap-2 w-72 shadow-md  duration-300 p-5">
    //       <span className="font-bold font-titleFont w-6 text-center">2</span>
    //       <p className="text-lightText text-base">Two years warranty</p>
    //     </div>
    //     <div className="flex md:w-auto items-center gap-2 w-72 shadow-md  duration-300 p-5">
